					...
					<ScrollView showsVerticalScrollIndicator={false}>
						<View style={{ flexDirection: 'row' }}>
							<ScrollView horizontal={true} showsHorizontalScrollIndicator={false}>
								{/* <AddImage onPick={props.onPickMultiple.bind(this)} />
								{this.state.myCat ? (
									this.state.myCat.map((i: any, index: any) => (
										<View key={index}>{this._renderAsset(i, index)}</View>
									))
								) : null} */}
							</ScrollView>
						</View>
						<View style={_styles.formGroups}>
							...
							<View style={_styles.rows}>
								<View style={styles.leftBox}>
									<OutlinedTextField
										...
										labelFontSize={10}
										defaultValue={String(this.props.cost)}
								...
								<View style={styles.rightBox}>
									<OutlinedTextField
										...
										tintColor={modules.PRIMARY}
										labelFontSize={10}
										defaultValue={String(this.props.price)}
										keyboardType="decimal-pad"
								...
								{/* <View style={styles.rightBox}>
									<TextField
										...
										tintColor={modules.PRIMARY}
										labelFontSize={10}
										value={this.props.comparePrice}
										onChangeText={(val) => this.props.changeComparePrice(val)}
									/>
								</View> */}
							</View>
							<OutlinedTextField
							...
							<View style={_styles.separate}>
								...
								<Dropdown
									...
									data={status}
									value={dataSelectedProduct.status ? dataSelectedProduct.status.name : ''}
