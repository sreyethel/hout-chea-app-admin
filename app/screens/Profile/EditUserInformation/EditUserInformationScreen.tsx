...
export default class EditUserInformationScreen extends React.Component<AppProps, AppState> {
	...
	onUpdateProfile = () => {
		...
		this.props.updateProfile(item, this.props.image);
	};
...
const styles = StyleSheet.create({
	...
	textFieldWrapper: {
		...
		paddingHorizontal: Platform.OS == 'android' ? MODULE.BODY_HORIZONTAL : MODULE.BODY_HORIZONTAL,
		flexDirection: 'row',
